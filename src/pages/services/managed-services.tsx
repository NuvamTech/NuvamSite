...
export function ManagedServicesService() {
  const navigate = useNavigate();

  return (
    <div className="min-h-screen bg-surface">
      <SEO
        title="Managed IT & Software Support Services | Nuvam Infotech"
        description="24/7 technical support, system maintenance, and cloud monitoring. Ensure uptime and high security for your custom applications."
        keywords="managed IT services, software maintenance, cloud monitoring, application support"
      />
        ...
        <div className="mx-auto max-w-5xl px-4 sm:px-6 relative z-10">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-lg md:text-xl text-muted max-w-2xl mx-auto leading-relaxed">
              Post-launch operations, server monitoring, security updates, and bug fixes around the clock — so you can focus on growing your business.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid gap-12 lg:grid-cols-2 items-center">
            <div className="space-y-6">
              <h2 className="font-display text-3xl md:text-4xl font-bold text-ink">
                Your Technology. Fully Managed. Always On.
              </h2>
              <p className="text-base md:text-lg text-muted leading-relaxed">
                Running enterprise software requires constant attention — patching servers, monitoring performance, responding to incidents, and managing security threats. NUVAM Managed Services gives you a dedicated operations team at a fraction of the cost.
              </p>
              <p className="text-base md:text-lg text-muted leading-relaxed">
                We operate as an extension of your team, providing proactive monitoring, rapid incident response, and continuous optimization to keep your systems running at peak performance.
              </p>
              <div className="grid gap-4 sm:grid-cols-2">
                {[
                  ...
                  'Continuous cost optimization and rightsizing'
                ].map((item, i) => (
            ...
            <div className="relative">
              ...
              <div className="relative bg-gradient-to-br from-surface to-bg border border-hairline/50 rounded-2xl p-8 shadow-xl">
                <h3 className="font-bold text-ink mb-6 pb-3 border-b border-hairline/50">Service Tiers</h3>
                <div className="space-y-5">
                  {[
                    { label: 'Standard', value: 'Business hours support, monitoring, monthly reporting' },
                    { label: 'Advanced', value: '16/5 support, proactive alerts, quarterly reviews' },
                    { label: 'Premium', value: '24/7 support, dedicated engineer, SLA guarantee' },
                    { label: 'Response Time', value: 'P1 critical: 1hr, P2 high: 4hrs, P3: 24hrs' }
                  ].map((row, i) => (
      ...
      <section className="py-16 md:py-24 border-t border-hairline/40 bg-gradient-to-br from-[var(--accent)]/5 via-[var(--accent-2)]/5 to-[var(--accent-gold)]/5">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 text-center">
          ...
          <p className="text-lg md:text-xl text-muted max-w-2xl mx-auto mb-8">
            Get a free operations review and discover what a managed services partnership looks like for your environment.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button to="/#contact" className="w-full sm:w-auto px-8 py-4 text-base">
              Get Free Operations Review
            </Button>
