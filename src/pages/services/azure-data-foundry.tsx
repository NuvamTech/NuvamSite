...
export function AzureDataFoundryService() {
  return (
    <div className="min-h-screen bg-surface">
      <SEO
        title="Azure Data Factory & Integration Services | Data Engineering"
        description="Integrate disparate enterprise databases with Azure Data Factory. Clean, transform, and pipe big data into secure data lakes."
        keywords="Azure Data Factory, data integration services, data pipelines, ETL architecture, cloud data warehouse"
      />
