...
export function CopilotAgentsService() {
  const navigate = useNavigate();

  return (
    <div className="min-h-screen bg-surface">
      <SEO
        title="Custom Copilots & AI Agents | Microsoft Copilot Studio Partner"
        description="Build specialized conversational agents and AI assistants trained on your internal company databases. Deploy with Microsoft Copilot Studio."
        keywords="custom copilots, AI agents, Copilot Studio development, enterprise AI chatbot, conversational AI"
      />
        ...
        <div className="mx-auto max-w-5xl px-4 sm:px-6 relative z-10">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-lg md:text-xl text-muted max-w-2xl mx-auto leading-relaxed">
              Develop custom AI assistants, conversational chatbots, and customer-facing support agents using Microsoft Copilot Studio and Azure OpenAI.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid gap-12 lg:grid-cols-2 items-center">
            <div className="space-y-6">
              <h2 className="font-display text-3xl md:text-4xl font-bold text-ink">
                Intelligent Agents That Work for Your Business 24/7
              </h2>
              <p className="text-base md:text-lg text-muted leading-relaxed">
                AI-powered agents and copilots are reshaping how businesses handle support, operations, and knowledge management. NUVAM builds custom agents using Microsoft Copilot Studio and Azure OpenAI, trained on your data and tuned to your tone.
              </p>
              <p className="text-base md:text-lg text-muted leading-relaxed">
                Whether it's a customer-facing chatbot, an internal HR assistant, or a complex multi-agent orchestration system, we deliver reliable, enterprise-grade AI experiences.
              </p>
              <div className="grid gap-4 sm:grid-cols-2">
                {[
                  'Custom Copilot Studio agent development',
                  'Azure OpenAI GPT-4 integration',
                  'Knowledge-base powered Q&A bots',
                  'SharePoint and Teams-embedded assistants',
                  'Multi-agent orchestration with AutoGen',
                  'Customer support automation and ticketing bots'
                ].map((item, i) => (
            ...
            <div className="relative">
              ...
              <div className="relative bg-gradient-to-br from-surface to-bg border border-hairline/50 rounded-2xl p-8 shadow-xl">
                <h3 className="font-bold text-ink mb-6 pb-3 border-b border-hairline/50">AI Stack</h3>
                <div className="space-y-5">
                  {[
                    { label: 'Foundation Models', value: 'Azure OpenAI GPT-4o, GPT-4 Turbo' },
                    { label: 'Development Platform', value: 'Microsoft Copilot Studio' },
                    { label: 'Deployment', value: 'Teams, SharePoint, Web Chat, WhatsApp' },
                    { label: 'Retrieval', value: 'Azure AI Search, RAG Architecture' }
                  ].map((row, i) => (
      ...
      <section className="py-16 md:py-24 border-t border-hairline/40 bg-gradient-to-br from-[var(--accent)]/5 via-[var(--accent-2)]/5 to-[var(--accent-gold)]/5">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 text-center">
          ...
          <p className="text-lg md:text-xl text-muted max-w-2xl mx-auto mb-8">
            Schedule a demo to see what a custom copilot can do for your team in 30 days.
          </p>
...
export default CopilotAgentsService;
