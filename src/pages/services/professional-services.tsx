...
export function ProfessionalServicesService() {
  const navigate = useNavigate();

  return (
    <div className="min-h-screen bg-surface">
      <SEO
        title="Professional Software Engineering Services | Nuvam Tech"
        description="On-demand tech teams and senior software engineers to accelerate your development cycles and IT projects."
        keywords="software engineering services, dedicated development team, hire developers"
      />
        ...
        <div className="mx-auto max-w-5xl px-4 sm:px-6 relative z-10">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-lg md:text-xl text-muted max-w-2xl mx-auto leading-relaxed">
              Dedicated technical experts to deploy, integrate, and configure third-party software so your team can focus on what matters.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid gap-12 lg:grid-cols-2 items-center">
            <div className="space-y-6">
              <h2 className="font-display text-3xl md:text-4xl font-bold text-ink">
                Specialist Execution for Complex Technology Projects
              </h2>
              <p className="text-base md:text-lg text-muted leading-relaxed">
                NUVAM's professional services teams provide the hands-on technical muscle to deliver complex software implementations on time and budget. From ERP go-lives to Azure migrations, we execute with precision.
              </p>
              <p className="text-base md:text-lg text-muted leading-relaxed">
                We supplement your internal IT teams or lead implementations end-to-end — providing certified specialists, structured project management, and quality assurance throughout.
              </p>
            ...
            <div className="relative">
              ...
              <div className="relative bg-gradient-to-br from-surface to-bg border border-hairline/50 rounded-2xl p-8 shadow-xl">
                <h3 className="font-bold text-ink mb-6 pb-3 border-b border-hairline/50">Delivery Methodology</h3>
                <div className="space-y-5">
                  {[
                    { label: 'Phase 1', value: 'Discovery, requirement gathering, and project scoping' },
                    { label: 'Phase 2', value: 'Configuration, development, and unit testing' },
                    { label: 'Phase 3', value: 'User acceptance testing and stakeholder sign-off' },
                    { label: 'Phase 4', value: 'Go-live, hypercare support, and knowledge transfer' }
                  ].map((row, i) => (
      ...
      <section className="py-16 md:py-24 border-t border-hairline/40 bg-gradient-to-br from-[var(--accent)]/5 via-[var(--accent-2)]/5 to-[var(--accent-gold)]/5">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 text-center">
          <h2 className="font-display text-3xl md:text-4xl lg:text-5xl font-bold text-ink mb-6">
            Let's Deliver Your Next Project Together
          </h2>
          <p className="text-lg md:text-xl text-muted max-w-2xl mx-auto mb-8">
            Contact our professional services team to discuss your upcoming implementation or integration project.
          </p>
...
export default ProfessionalServicesService;
